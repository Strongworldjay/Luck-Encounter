...
const characters = [
  {
    ...
    skills: ['Acrobatics', 'Arcana', 'Deception', 'History', 'Insight', 'Persuasion', 'Stealth',],
    class: 'Sorcerer 16/Bard 3',
    subclass: 'Wild Magic/College of Lore',
    exp: 305000,
    skillPoints: 3,
    stats: {
  ...
  },
  {
    ...
    skills: ['History', 'Insight', 'Intimidation', 'Medicine', 'Perception', 'Persuasion', 'Religion', 'Survival'],
    class: 'Cleric',
    subclass: 'Forge',
    exp: 120000,
    skillPoints: 3,
  ...
  },
  {
    ...
    age: 30,
    alignment: 'Chaotic Good',
    skills: ['Acrobatics', 'Athletics', 'Insight', 'Intimidation', 'Investigation', 'Perception', 'Survival'],
    class: 'Fighter',
  ...
  },
  {
    ...
    age: 30,
    alignment: 'Neutral',
    skills: ['Acrobatics', 'Animal Handling', 'Athletics', 'Intimidation', 'Nature', 'Perception', 'Stealth', 'Survival'],
    class: 'Barbarian',
    subclass: 'Path of the Totem',
    exp: 140000,
    skillPoints: 3,
    stats: {
      strength: { score: 20, modifier: '+5' },
