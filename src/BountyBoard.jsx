...
const bountyData = [
  {
    ...
    location: "Rocky coastal waters and fog-heavy hunting routes near local shipping lanes.",
    physicalDescription:
    ...
    jobPoster: "Posted by the Adventurer's Guild on behalf of local harbor interests and surviving witnesses.",
  },
  {
    ...
    location: "Previously located near reef shelves and jagged coastal rock formations.",
    physicalDescription:
    ...
    jobPoster: "Originally posted by the Adventurer's Guild at the request of coastal merchants.",
  },
  {
    ...
    location: "Most often sighted in fog-heavy city streets, alleyways, and wealthier night districts.",
    physicalDescription:
    ...
    jobPoster: "Posted by the Adventurer's Guild under contract from wealthy city patrons and affected families.",
  },
  {
    ...
    location: "West Gloam lighthouse shoals, surrounding piers, skiffs, and submerged stonework.",
    physicalDescription:
    ...
    jobPoster: "Posted by the Adventurer's Guild on behalf of West Gloam lighthouse wardens and nearby fishermen.",
  },
  {
    ...
    location: "Deep within an isolated sewer offshoot connected indirectly to the canal network.",
    physicalDescription:
    ...
    jobPoster: "Posted by the Adventurer's Guild on behalf of Harbor Wardens and canal maintenance officials.",
  },
  {
    ...
    location: "A semi-popular tavern and inn on the outskirts, including its basement, roof spaces, and trap-lined approach routes.",
    physicalDescription:
    ...
    jobPoster: "Posted by the Adventurer's Guild at the request of the innkeeper and nearby locals.",
  },
];
