...
export const CANTRIPS = [
  ...
  },
  {
    ...
    attackType: "Ranged Spell Attack",
    damageTypes: ["Radiant"],
    conditions: ["Speed -10 ft. (Undead/Fiend/Fey, until end of next turn)", "No Reactions (Undead/Fiend/Fey, until end of next turn)"],
    components: { verbal: true, somatic: true, material: false, materialText: "" },
    concentration: false,
    ritual: false,
    descriptionMd:
  ...
  },
  {
    ...
    duration: "1 minute",
    range: "Self",
    area: "Self (finger-gun weapon, range 60/240 ft.)",
    tags: ["Cantrip", "Damage"],
    saveRequired: "None",
    attackType: "Ranged Spell Attack",
    damageTypes: ["Force"],
  ...
  },
  {
    ...
    range: "30 feet",
    area: "1 creature",
    tags: ["Cantrip", "Summoning", "Damage", "Control"],
    saveRequired: "CON",
    attackType: "Spell",
    damageTypes: ["Poison"],
    conditions: ["Deafened"],
  ...
  },
  {
    ...
    duration: "12 hours",
    range: "Touch",
    area: "1 sack up to 5 pounds of perishables",
    tags: ["Utility"],
    saveRequired: "None",
    attackType: "None",
    damageTypes: [],
  ...
  },
  {
    ...
    duration: "Instantaneous",
    range: "10 feet",
    area: "1 creature that provoked your opportunity attack",
    tags: ["Control"],
    saveRequired: "None",
    attackType: "None",
    damageTypes: [],
