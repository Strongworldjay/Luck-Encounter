...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Call forth a **Fey Spirit** (mood: **Fuming**, **Mirthful**, or **Tricksy**) in an unoccupied space. It acts right after you, obeys your verbal commands, and vanishes at 0 HP or when the spell ends. Stat block scales with slot level; it can **Fey Step** with an extra mood effect (advantage on next attack; charm a nearby creature; or create a brief **10-ft cube of magical Darkness**).",
  scalingMd:
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Call forth an **Undead Spirit** (form: **Ghostly**, **Putrid**, or **Skeletal**). It acts immediately after you and follows verbal commands. Form grants traits like **Incorporeal Passage** (Ghostly) or **Festering Aura** (Putrid). Attacks and features vary by form; it disappears at 0 HP or when the spell ends.",
  scalingMd:
    "**Using a Higher-Level Spell Slot.** Use the slot’s level for the spirit’s **AC/HP/attacks/damage** as indicated in the stat block.",
