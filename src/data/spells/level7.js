...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Manifest a **pillar of Upper-Planes light** in a **10-ft-radius, 40-ft-high cylinder**. For each creature you can see in the cylinder, choose **Healing Light** (*regains **4d12 + your spellcasting mod** HP*) or **Searing Light** (*DEX save; **6d12 Radiant**, half on success*). The cylinder emits **bright light** and can be **moved up to 30 ft** when you move on your turn. A creature can be affected **once per turn** when it enters, ends turn in, or the cylinder moves into its space.",
  scalingMd:
    "**Using a Higher-Level Spell Slot.** Healing and damage each increase by **1d12** per slot level above 7.",
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "A **glowing bead** forms at a point in range. When the spell ends, it **explodes**, and creatures in a **20-ft-radius sphere** make a **DEX save**, taking **Fire damage equal to the accumulated total** (fail) or half (success). Base damage **12d6**, **+1d6** at the **end of each of your turns** while maintained. A creature touching the bead can **DEX save** to **throw it up to 40 ft**; on a fail it detonates. The explosion ignites unattended flammables.",
  scalingMd:
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Speak a **word of celestial power**. Each chosen creature in range makes a **CHA save**; on a fail and **≤50 HP**, it suffers an effect by HP: **41–50 Deafened (1 min)**, **31–40 Deafened & Blinded (10 min)**, **21–30 Deafened, Blinded & Stunned (1 hr)**, **0–20 dies**. Regardless of HP, **Celestials, Elementals, Fey, and Fiends** that fail are **banished to their home plane** and **barred for 24 hours** (short of *wish*).",
  scalingMd: "",
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Blast a creature with **negative energy**. **CON save**; **7d8 + 30 Necrotic** on fail (half on success). A **Humanoid** killed by this rises at the **start of your next turn** as a **Zombie** under your verbal command.",
  scalingMd: "",
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Create a **shimmering door** to an extradimensional mansion (up to **50 contiguous 10-ft cubes**), fully furnished and warm, with food for a **nine-course banquet for 100** and a staff of **100 invulnerable unseen servants**. You designate who can enter; the door can be opened/closed (no action) within **30 ft** and is **imperceptible when closed**. Objects can’t be removed permanently; they dissipate. When the spell ends, occupants are **expelled** near the door.",
  scalingMd: "",
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Eight **prismatic rays** flash in a **60-ft cone**. Each creature makes a **DEX save**, then roll **1d8** for each target: **1 Red (12d6 Fire)**, **2 Orange (12d6 Acid)**, **3 Yellow (12d6 Lightning)**, **4 Green (12d6 Poison)**, **5 Blue (12d6 Cold)**, **6 Indigo (Restrained; CON saves at EoT—3 successes end; 3 fails → Petrified)**, **7 Violet (Blinded; WIS save at start of your next turn: success ends; fail ends then **banishes** to a random plane)**, **8 Special** (roll **two** rays, reroll 8s). Half damage on a successful save for rays 1–5.",
  scalingMd: "",
