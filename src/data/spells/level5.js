...
},
{
  ...
  name: "Hold Monster",
  classes: ["Bard", "Sorcerer", "Warlock", "Wizard", "War Domain", "Circle of the Sea", "Oath of Vengeance", "Oath of Castigation"],
  spellLevel: 5,
  school: "Enchantment",
  castingTime: "1 action",
  duration: "Concentration, up to 1 minute",
...
},
{
  ...
  name: "Insect Plague",
  classes: ["Cleric", "Druid", "Sorcerer", "Fiend Patron", "Circle of the Hive"],
  spellLevel: 5,
  school: "Conjuration",
  castingTime: "1 action",
  duration: "Concentration, up to 10 minutes",
...
},
{
  ...
  name: "Mislead",
  classes: ["Bard", "Warlock", "Wizard", "Twilight Domain", "Fey Wanderer", "The Many", "The Predator", "Circle of the Hive"],
  spellLevel: 5,
  school: "Illusion",
  castingTime: "1 action",
  duration: "Concentration, up to 1 hour",
...
},
{
  ...
  name: "Seeming",
  classes: ["Bard", "Sorcerer", "Wizard", "Gloom Stalker", "Archfey Patron"],
  spellLevel: 5,
  school: "Illusion",
  castingTime: "1 action",
  duration: "8 hours",
...
},
{
  ...
  classes: ["Ranger", "Wizard", "War Domain"],
  spellLevel: 5,
  school: "Conjuration",
  castingTime: "1 action",
  duration: "Instantaneous",
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Call forth a **Celestial spirit** (choose **Avenger** or **Defender**). It appears in an unoccupied space and uses the **Celestial Spirit** stat block, acting after you and obeying **verbal commands** (no action). If uncommanded, it **Dodges** and avoids danger; it vanishes at **0 HP** or when the spell ends.\n\n**Stat Block (summary).** *Large Celestial; AC **11 + slot level** (**+2** if Defender); HP **40 + 10/slot above 5**; Speed **30 ft., fly 40 ft.**; Resist **Radiant**; Immune **Charmed, Frightened**; Darkvision 60 ft.; languages **Celestial**, understands yours. **Multiattack** = half slot level.\n**Radiant Bow** (Avenger, 600 ft.): **2d6 + 2 + slot** Radiant. **Radiant Mace** (Defender, 5 ft.): **1d10 + 3 + slot** Radiant, and grant **1d10 temp HP** to itself or a creature within **10 ft.** **Healing Touch (1/day):** **2d8 + slot** HP.",
  scalingMd:
...
},
{
  ...
  ritual: false,
  descriptionMd:
    "Call forth a **Draconic spirit** in an unoccupied space. It uses the **Draconic Spirit** stat block, acts after you, obeys **verbal commands** (no action), and vanishes at **0 HP** or when the spell ends. When summoned, choose one of its **Resistances**; you gain the same **Resistance** for the duration.\n\n**Stat Block (summary).** *Large Dragon; AC **14 + slot level**; HP **50 + 10/slot above 5**; Speed **30 ft., fly 60 ft., swim 30 ft.**; Resist **Acid, Cold, Fire, Lightning, Poison**; Immune **Charmed, Frightened, Poisoned**; Blindsight 30 ft., Darkvision 60 ft.; languages **Draconic**, understands yours. **Multiattack** = half slot level and **Breath Weapon**.\n**Rend** (10-ft. reach): **1d6 + 4 + slot** Piercing. **Breath Weapon** (30-ft. cone, **DEX save**): **2d6** damage of one of its resistances (**your choice when cast**; half on success).",
  scalingMd:
    "**Using a Higher-Level Spell Slot.** Use the **slot’s level** for the stat block’s level-based values.",
...
},
{
  ...
  name: "Telekinesis",
  classes: ["Sorcerer", "Wizard", "Aberrant Sorcery", "Great Old One Patron", "Great Fool Patron"],
  spellLevel: 5,
  school: "Transmutation",
  castingTime: "1 action",
  duration: "Concentration, up to 10 minutes",
...
},
{
  ...
  name: "Tree Stride",
  classes: ["Druid", "Ranger", "Oath of the Ancients"],
  spellLevel: 5,
  school: "Conjuration",
  castingTime: "1 action",
  duration: "Concentration, up to 1 minute",
...
},
{
  ...
  name: "Wall of Stone",
  classes: ["Artificer", "Druid", "Sorcerer", "Wizard", "The Genie (TCoE)"],
  spellLevel: 5,
  school: "Evocation",
  castingTime: "1 action",
  duration: "Concentration, up to 10 minutes",
...
},
{
  ...
  classes: ["Bard", "Wizard", "Oath of Glory"],
  spellLevel: 5,
  school: "Enchantment",
  castingTime: "1 action",
  duration: "Concentration, up to 1 minute",
