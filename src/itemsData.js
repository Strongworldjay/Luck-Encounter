export const itemNames = {
    Helmet: {
        ...
        Uncommon: [
            "Dusk Mask", "Lupine Mask", "Cap of Curing",
        ...
        Rare: [
            ...
            "Avian Circlet", "Focus Circlet (Rare)", "Helm of The Juggernaut",
    ...
    Necklace: {
        ...
        Rare: ["Meta Medallion", "Necklace of Fireballs", "Necklace of Ice Spikes",
            "Necklace of Nine Lives", "Necklace of Prayer Beads", "Necklace of Thunderbolts", "Burning Battle Amulet",
    ...
    Cloak: {
        ...
        Rare: ["Cloak of Displacement", "Cloak of The Depths", "Cloak of the Bat", "Cloak of the Boundless Spirit", "Cloak of the Djinni", "Cloak of the Protector's Charge", "Cloak of the Riverstalker",
            ...
            "Cape of the Mountebank", "Knifewing Cape", "Kagonesti Forest Shroud", "Carrion Shroud", "Cloak of Sturdy Stance", "MAster Cloak of the Hummingbird",
    ...
    Bow: {
        ...
        VeryRare: ["Arc of the Alicorn ( Longbow )", "Arkano Longbow", "Energy Longbow", "Foresight Longbow", "Longbow of Melodies", "Longbow of Throne's Command",
            ...
            "Ruidium Sling", "Sling, +3", "Titanpiercer" ],
    ...
    Glaive: {
        ...
        Rare: ["Coldfire Glaive", "Corpse Slayer, Glaive", "Dragon Slayer Glaive", "Flame Tongue Glaive", "Giant Slayer Glaive",
            ...
            "Weapon of Certain Death, Glaive", "Covolt Scythe", "Unseen Scythe"
        ],
    ...
    Dagger: {
        ...
        Uncommon: ["Adamantine Dagger", "Bloodthirsty Bistoury ( Dagger )", "Courtesan's Fanblade ( Dagger )", "Covolt Dagger", "Dagger of Blind Faith", "Dagger of First Light",
            ...
            "Frozen Dagger", "Galepierce Dagger", "Glass Carver ( Dagger )", "Hellfire Dagger", "Riff's Dimensional Ripper ( Dagger )",
            "Young Dragon Edge Dagger", "Adamantine Sickle", "Harvest Sickle", "Hellfire Sickle", "Ice Sickle", "Moon Sickle, +1", "Sickle of Blind Faith",
            "Sickle of Spite", "Sickle of Verdict", "Sickle of Warning", "Sickle, +1", "Young Dragon Edge Sickle", "Feather Dagger"
        ],
        Rare: ["Adult Dragon Edge Dagger", "Bandolier of the Elements ( Daggers )", "Basilisk Dagger", "Coldfire Dagger", "Corpse Slayer, Dagger", "Couatl Herald's Fang Dagger",
            ...
            "Dragon Slayer Dagger", "Dragonkin Dagger +1", "Dragontooth Dagger", "Dusk Dagger (Rare)", "Faithful Feathers Daggers", 
        ...
        Legendary: ["Defender Dagger", "Dragonkin Dagger +3", "Heaven's Edge ( Dagger )", "Starsever",
    ...
    Halberd: {
        ...
        Legendary: [
            ...
            "Holy Avenger Halberd", "Soul-Searing Scythe", "Crownmaker"
        ],
        Unique: [
  ...
  Common: [
    ...
    "Hunter's Mark Spell Scroll", "Hydrathorne's Hydra Breath Spell Scroll", "Ice Knife Spell Scroll",
    ...
    "Magic Missile Spell Scroll", "Magic Stone Spell Scroll", "Magnify Gravity Spell Scroll",
    "Manilo's Exploit Spell Scroll", "Map or Scroll Case", "Mending Spell Scroll",
    "Message Spell Scroll", "Mind Sliver Spell Scroll", "Minor Illusion Spell Scroll",
    "Mold Earth Spell Scroll", "Multishot Spell Scroll", "Nauseating Poison Spell Scroll",
    "Nonalla's Spell Ward Spell Scroll", "Poison Spray Spell Scroll", "Prestidigitation Spell Scroll",
  ...
  Uncommon: [
   ...
   "Rope Trick Spell Scroll", "Scorching Ray Spell Scroll",
    "Scroll of Mapping (Uncommon)", "Scroll of Rugs", "See Invisibility Spell Scroll",
  ...
  Rare: [
    ...
    "Sky Burst Spell Scroll", "Sonic Shriek Spell Scroll", "Soul Cage Spell Scroll", "Spell Scroll (4th Level)",
    "Spell Scroll (5th Level)", "Spell Scroll (Level 4)", "Spell Scroll (Level 5)", "Staggering Smite Spell Scroll",
  ...
  VeryRare: [
    ...
    "Resurrection Spell Scroll", "Reverse Gravity Spell Scroll", "Scroll of Mapping (Very Rare)", "Sequester Spell Scroll", "Simulacrum Spell Scroll",
